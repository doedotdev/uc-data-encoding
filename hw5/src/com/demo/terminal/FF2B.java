...
/**
 * Created by benjamin.horn on 3/2/17.
 */
...
public class FF2B extends FF2A {
    ...
    // reused from FF2A ecrypted essentially
    private void decrypted(){ // reused from FF2A ecrypted essentially
