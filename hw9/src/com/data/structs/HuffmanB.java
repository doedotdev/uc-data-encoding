 ...
 void decode(){  // Your two lines of code for updating k are needed for this to work.
  ...
  while ((bit = inputBit()) >= 0){
    // Your code: replace k by the index of a child according to bit (Walk down tree)
      k = codetree[k][bit];
      compressed_bits = compressed_bits +1;
    if (codetree[k][0] == 0){  // leaf
     ...
     System.out.println("uncompressed: " +  filesize);
     System.out.println("compressed: " + compressed_bits / 8);
     System.out.println("Ratio: " + (double)compressed_bits / (double)filesize);
     System.out.flush();
 }

 public static void main(String[] args){
     System.out.println("huff B");
